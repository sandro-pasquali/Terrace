//	TODO: more of the spec http://ascii-table.com/ansi-escape-sequences-vt-100.php
//	Add some sort of default fg/bg commands...
//
...
var get = function(cmd) {
	...
	//	If the cli argument is numeric, return the value as a true numeric value.
	//
...
//  Initialize.
//  Parse kit startup options, initialize cli option collections.
//
(function(o) {
    ...
    option("--help", {
        ...
        action      : function() {
            ...
            for(p in om) {
                ...
                str += "@blue" + $.string.$padRight(" ", mwidth, om[p].join(" ")) + "\t@green" + op[p].description + "@@`"
            }
...
for(v in fgcolors) {
	_cli[v] = rf(fgCode, v);
	_cli["bg" + $.string.$ucwords(v)] = rf(bgCode, v)
};
