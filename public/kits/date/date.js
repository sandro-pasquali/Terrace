...
$.addKit("date", {
	...
	//
	//	@param	{String}	lang	A language code like "it" or "ru".
	//	@param	{Function}	[cb]	Function to call when pack is loaded.
	//
	loadLang	: function(lang, cb) {
		this.loadModule($.$n.path + "kits/date/lang/" + lang + ".js", cb);
	},

	//	##lang
	//
	//	Sets the current language data. This is called by language packs, and it is
	//	unlikely that you'd need to call this directly.
	//
	lang	: moment.lang,

	//	##setTime
	//
	//	Establishes what "now" is for the date object.
	//
	setTime	: function(a, b) {
		this.set("_T", moment(a, b));
	},
	...
	//
	utc	: function() {
		return this.$get("_T").utc()
	},

	//	##add
	//
	//	Adds some amount of time to current time.
	//
	add	: function(a, b) {
		return this.$get("_T").add(a, b);
	},

	//	##subtract
	//
	//	Subtract some amount of time from current time.
	//
	subtract	: function(a, b) {
		return this.$get("_T").subtract(a, b);
	},

	//	##format
	//
	format	: function(a) {
		return this.$get("_T").format(a);
	},

	//	##from
	//
	from	: function(a, b) {
		return this.$get("_T").from(a, b);
	}
});
