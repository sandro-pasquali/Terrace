Terrace.subscribe("bit:stats:loaded", function(bit) {
...
var width		= bit.params.$get("width");
var height		= bit.params.$get("height");
var placement	= bit.params.$get("placement") || "bottomright";
...
console.log(bit.view)

bit.view.append(stats.element);
